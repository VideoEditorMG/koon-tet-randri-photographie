...
export default function Home() {
  ...
  return (
    <div className="relative w-full">
      <section className="relative min-h-screen w-full overflow-hidden pt-20 bg-dark">
        <div className="absolute inset-0 bg-noise opacity-[0.02] pointer-events-none" />
        
        <div className="max-w-[1800px] mx-auto w-full min-h-[calc(100vh-5rem)] flex flex-col lg:flex-row">
          ...
          <motion.div 
            ...
            className="w-full lg:w-3/5 relative bg-dark-accent overflow-hidden flex items-center justify-center p-8 md:p-12"
          >
            {/* Large Artistic Frame */}
            <div className="w-full max-w-4xl h-full relative flex flex-col border border-white/5 bg-dark shadow-2xl overflow-hidden aspect-[4/5] lg:aspect-auto">
